...
let whiteBrn = document.getElementById("whiteButton");
...
whiteBrn.addEventListener("click", switchToWhite);
blueBtn.addEventListener("click", switchToYellow);
yellowBtn.addEventListener("click", switchToBlue);